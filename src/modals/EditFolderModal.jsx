      ...
      <View style={styles.overlay}>
        ...
        >
          ...
          <View style={[styles.header, { borderBottomColor: colors.divider }]}>
            <Text style={[styles.title, { color: colors.textPrimary }]}>Edit Folder</Text>
          </View>
          ...
          <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.colorPreview, { backgroundColor: colors.surfaceHover, borderColor: colors.border }]}>
                <View style={[styles.previewCircle, { backgroundColor: selectedColor, borderColor: colors.surface }]}>
