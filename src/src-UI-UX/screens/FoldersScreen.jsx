...
export default function FoldersScreen() {
  ...
  const menuItems = [
    { icon: 'create-new-folder', label: 'New Folder', action: () => setNewFolderModalVisible(true) },
    { icon: 'sort', label: 'Sort By', action: () => console.log('Sort By') },
  ...
  const renderFolderItem = ({ item }) => (
    ...
    >
      <View style={styles.iconContainer}>
        <Icon name="folder" size={20} color="#787774" />
      </View>
